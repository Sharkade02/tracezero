...
| 21 | Localisation | IN_PROGRESS | — | **Infra complète** (`fr/en/de/es` à chaud, `ILocalizationService`, `Localizer`, sélecteur Paramètres, persistance). **Localisé en 4 langues** : **toute la navigation** (16 titres, rafraîchis live), page **Accueil**, page **Nettoyage**, page **Paramètres**, chrome du shell, libellés de risque/actions communs. **Reste** : chaînes internes des ~11 pages-outils, descriptions de règles, messages d'erreur (§31 « aucun texte hardcodé ») → `KNOWN_LIMITATIONS.md` |
